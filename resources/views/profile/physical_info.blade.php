                                        ...
                                        <div class="panel-group" id="accordion1">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">Basic Information @if($physical_info)<a class="text-right" style="float: right" href="{{ url('physical-info-edit') }}">Edit</a>@endif</h4>
                                                </div>
                                                        ...
                                                        @if($physical_info)
                                                            <table class="table table-hover">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $physical_info->strong_disease }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>রক্ত চাপের অবস্থা</th>
                                                                    <td>{{ $physical_info->blood_pressure }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>রক্তের গ্রুপ</th>
                                                                    <td>{{ $physical_info->blood_group }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>ডায়াবেটিস এর অবস্থা</th>
                                                                    <td>{{ $physical_info->diabetes }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>খাবারে মৌলিক সমস্যা</th>
                                                                    <td>{{ $physical_info->food_problem }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>হাঁটা-চলায় সমস্যা</th>
                                                                    <td>{{ $physical_info->walking_problem }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>ইংলিশ কমোড ব্যবহার করেছেন?</th>
                                                                    <td>{{ $physical_info->is_use_english_commode }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>দেখে-দেখে কুরআন পরতে পারেন?</th>
                                                                    <td>{{ $physical_info->is_reading_quran }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>সহীহভাবে কুরআন পরতে পারেন?</th>
                                                                    <td>{{ $physical_info->is_read_quran_sahih }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>সালাতের সূরা ও তাজবীহ সহীহভাবে পড়তে পারেন?</th>
                                                                    <td>{{ $physical_info->is_salat_sahih_reading }}</td>
                                                                </tr>
