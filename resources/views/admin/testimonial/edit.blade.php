...
@section('content')
    ...
    <div id="main" role="main">
        <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    <li>Home</li><li>Edit Testimonial</li>
                </ol>
        </div>
                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                    {!! Form::open(['action'=>['Admin\TestimonialController@update',$testimonial->id],'method'=>'PUT','files'=>true]) !!}
                                    <div class="row">
                                        <div class="col-md-8">

                                            <div class="form-group">
                                                <label>Title</label>
                                                <input type="text" class="form-control" value="{{$testimonial->name}}" required name="name">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Status</label>
                                                {!! Form::select('status', ['Active' => 'Active','InActive' => 'InActive'], $testimonial->status,['class'=>'form-control']) !!}<i></i>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <img id="holder_image" src="{{asset($testimonial->image)}}" style="margin-top:15px;margin-bottom:5px;max-width:100%;">
                                                @php $file_array = explode('/',$testimonial->image); @endphp
                                                ...
                                                <div class="input-group">
                                                      <span class="input-group-btn">
                                                        <a  data-input="thumbnail_image" data-preview="holder_image" style="width: 100%" class="lfm btn btn-primary">
                                                          <i class="fa fa-picture-o"></i> {{($testimonial->image)?'Change Image':'Choose Image'}}
                                                        </a>
                                                      </span>
                                                    <input id="thumbnail_image" class="form-control" type="hidden" value="{{$testimonial->image}}" name="image">
                                                </div>
                                            </div>
                                        ...
                                        <footer>
                                            ...
                                            <a  class="btn btn-default" href="{{url('admin/testimonial')}}">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>
