...
@section('content')
    ...
    <div id="main" role="main">
        <div id="ribbon">
                ...
                <ol class="breadcrumb">
                    <li>Home</li><li>Add Testimonial</li>
                </ol>
        </div>
                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                        {!! Form::open(['action'=>'Admin\TestimonialController@store','files'=>true]) !!}
                                        <div class="row">
                                            <div class="col-md-8">
                                        ...
                                        <footer>
                                            ...
                                            <a href="{{ url('admin/testimonial') }}" class="btn btn-default">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>
