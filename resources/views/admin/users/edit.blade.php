                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('user_status', [ '2' => 'Active', '0' => 'InActive'], $user->user_status,['class'=>'form-control']) !!} <i></i>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <img id="holder_image" src="{{asset($user->profile_image)}}" style="margin-top:15px;margin-bottom:5px;max-width:100%;">
                                                @php $file_array = explode('/',$user->profile_image); @endphp
                                                ...
                                                <div class="input-group">
                                                      <span class="input-group-btn">
                                                        <a  data-input="thumbnail_image" data-preview="holder_image" style="width: 100%" class="lfm btn btn-primary">
                                                          <i class="fa fa-picture-o"></i> {{($user->profile_image)?'Change profile Image':'Choose profile Image'}}
                                                        </a>
                                                      </span>
                                                    <input id="thumbnail_image" class="form-control" type="hidden" value="{{$user->profile_image}}" name="profile_image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
