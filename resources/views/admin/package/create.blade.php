                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                        {!! Form::open(['action'=>'Admin\PackageController@store','files'=>true]) !!}
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <label>Features <span class="val">*</span></label>
                                                ...
                                                <div class="form-group ckeditor">
                                                    ...
                                                    <textarea class="editor"  rows="20" name="detail" class="custom-scroll form-control"></textarea>
                                                </div>

                                                <div class="form-group">
                                                    <label>Packege Type</label>
                                                    {!! Form::select('package_type', ['Hajj' => 'Hajj','Umrah' => 'Umrah'], old('package_type'),['class'=>'form-control']) !!}<i></i>
                                                </div>
                                        ...
                                        <footer>
                                            ...
                                            <a href="{{ url('admin/package') }}" class="btn btn-default">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>
