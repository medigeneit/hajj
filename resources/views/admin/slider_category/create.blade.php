                    ...
                    <article class="">
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            <header>
                                ...
                                <h2>Add slider_category </h2>
                            </header>
                            <div>
                                <div class="widget-body">
                                        {!! Form::open(['action'=>'Admin\SliderCategoryController@store','files'=>true,'class'=>'']) !!}
                                        <div class="row">
                                            <div class="col-md-12">
...
@section('js')
    ...
    <script>
        var editor_config ={
            ...
            plugins: [
                ...
                "emoticons SliderCategory paste textcolor colorpicker textpattern",
                "textcolor"
            ],
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('[name="slider_category"]').on('change', function() {

                var slider_category = $(this).val();
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '/extra-fields',
                    data: {slider_category: slider_category},
